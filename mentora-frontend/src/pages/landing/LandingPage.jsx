...
const STEPS = [
  {
    ...
    description:
      "Regista-te gratuitamente como mentor ou mentorado em poucos minutos.",
  },
  {
    number: "2",
    title: "Encontra o mentor certo",
    description:
      "Filtra por área, preço e avaliação para encontrares quem melhor te pode ajudar.",
  },
  {
    number: "3",
    title: "Agenda e evolui",
    description:
      "Marca a tua sessão, paga com segurança, e acompanha a tua evolução na plataforma.",
  },
];
...
export default function LandingPage() {
  ...
  useEffect(() => {
    searchMentors({ sortBy: "rating" }, 1, 3).then((result) => {
      setFeaturedMentors(result.mentors);
    });
  }, []);
      ...
      <section className="landing_hero">
        <div className="landing_hero-text">
          ...
          <div className="landing_hero-checks">
            ...
            <span>
              <FiCheck /> Mentores verificados
            </span>
            <span>
              <FiCheck /> Pagamento seguro
            </span>
          </div>
        </div>
      ...
      <section className="landing_mentors">
        ...
        <div className="landing_mentors-grid">
          {featuredMentors.map((mentor) => (
            <div key={mentor._id} className="landing_mentor-card">

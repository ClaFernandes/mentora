...
export default function LegalPage() {
  return (
    <div className="legal">
      ...
      <p className="legal_updated">Última atualização: setembro de 2026</p>
      <p className="legal_intro">
        Este documento reúne as regras de utilização do Mentora e explica como
        tratamos os teus dados pessoais. Lê com atenção antes de criar a tua
        conta.
      </p>
      ...
      <section>
        ...
        <div className="legal_item">
          ...
          <div>
            ...
            <p>
              ...
              comunidade. Ao criar uma conta, aceitas os termos descritos nesta
              página.
            </p>
          </div>
        </div>
        ...
        <div className="legal_item">
          ...
          <div>
            ...
            <p>
              ...
              sessão e disponibilidade. O Mentora atua como intermediário entre
              mentor e mentorado, não sendo parte na relação de aconselhamento
              prestada durante as sessões.
            </p>
          </div>
        </div>
        ...
        <div className="legal_item">
          ...
          <div>
            ...
            <p>
              ...
              apresentado no momento da reserva. As sessões só podem ser
              canceladas até 24 horas antes da hora marcada e, nesse caso, o
              valor pago é reembolsado. Não é possível cancelar com menos de 24
        ...
        <div className="legal_item">
          ...
          <div>
            ...
            <p>
              Ao publicar posts, comentários ou avaliações no Mentora, garantes
              que o conteúdo é da tua autoria ou que tens autorização para o
              partilhar. O Mentora reserva-se o direito de remover conteúdo que
              viole estes termos ou que seja reportado por outros utilizadores.
            </p>
          </div>
        </div>
        ...
        <div className="legal_item">
          ...
          <div>
            <h3>Conduta</h3>
            <p>
              Não é permitido usar a plataforma para assédio, discurso de ódio,
              fraude ou qualquer atividade ilegal. Contas que violem esta regra
              podem ser suspensas ou removidas pela administração.
            </p>
          </div>
        </div>
      ...
      <section>
        ...
        <div className="legal_item">
          ...
          <div>
            ...
            <p>
              Recolhemos o nome, email, foto de perfil (opcional) e, no caso de
              mentores, área de atuação e preço de sessão. Também guardamos o
              histórico de sessões agendadas e mensagens trocadas através do
              chat da plataforma.
            </p>
          </div>
        </div>
        ...
        <div className="legal_item">
          ...
          <div>
            ...
            <p>
              ...
              experiência na plataforma. Não vendemos os teus dados a terceiros.
            </p>
          </div>
        </div>
        ...
        <div className="legal_item">
          ...
          <div>
            ...
            <p>
              Partilhamos dados de pagamento com o Stripe, exclusivamente para
              processar as transações. Fotos de perfil e imagens de posts são
              armazenadas através do Cloudinary.
            </p>
          </div>
        </div>
        ...
        <div className="legal_item">
          ...
          <div>
            ...
            <p>
              ...
              encriptadas, para proteger a tua informação. No entanto, nenhum
              sistema é totalmente livre de risco.
            </p>
          </div>
        </div>
        ...
        <div className="legal_item">
          ...
          <div>
            ...
            <p>
              ...
              administração através dos canais disponibilizados na plataforma.
            </p>
          </div>
        </div>
      </section>

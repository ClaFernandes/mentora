            ...
            <div className="admin-chart-card">
                ...
                <ResponsiveContainer width="100%" height={280}>
                    <BarChart data={chartData}>
                        ...
                        <Tooltip />
                        <Legend />
                        <Bar yAxisId="left" dataKey="sessoes" name="Sessões" fill="var(--color-accent-secondary)" radius={[6, 6, 0, 0]} />
                        <Bar yAxisId="right" dataKey="receita" name="Receita (€)" fill="var(--color-accent)" radius={[6, 6, 0, 0]} />
                    </BarChart>
                </ResponsiveContainer>
            </div>

    ...
    offerings: [
      {
        ...
        sessionPrice: 45,
        description:
          "Sessões de mentoria em desenvolvimento full-stack, do zero ao primeiro emprego.",
      },
    ],
    isVerified: true,
    avgRating: 4.8,
    ...
    offerings: [
      {
        ...
        sessionPrice: 50,
        description:
          "Sessões práticas focadas em JavaScript moderno, React e boas práticas de código.",
      },
      {
        id: "o2",
        ...
        sessionPrice: 65,
        description:
          "Orientação em metodologias ágeis (Scrum/Kanban) para equipas de produto.",
      },
    ],
    isVerified: true,
    avgRating: 4.9,
    ...
    offerings: [
      {
        ...
        sessionPrice: 40,
        description:
          "Revisão de portfólio, fundamentos de design systems e prototipagem.",
      },
    ],
    isVerified: true,
    avgRating: 4.8,
    ...
    offerings: [
      {
        ...
        sessionPrice: 45,
        description:
          "Planeamento de campanhas, redes sociais e crescimento de marca.",
      },
    ],
    isVerified: true,
    avgRating: 5.0,
    ...
    offerings: [
      {
        ...
        sessionPrice: 60,
        description:
          "Orçamento, investimento e planeamento financeiro a longo prazo.",
      },
    ],
    isVerified: true,
    avgRating: 4.6,
    ...
    offerings: [
      {
        ...
        sessionPrice: 35,
        description:
          "Processos de recrutamento, employer branding e gestão de equipas.",
      },
    ],
    isVerified: true,
    avgRating: 4.7,
    ...
    offerings: [
      {
        ...
        sessionPrice: 25,
        description:
          "Prática de conversação e preparação para entrevistas em inglês.",
      },
      {
        id: "o8",
        ...
        sessionPrice: 30,
        description:
          "Apoio a professores iniciantes na criação de planos de aula.",
      },
    ],
    isVerified: false,
    avgRating: 4.2,
    ...
    offerings: [
      {
        ...
        sessionPrice: 70,
        description:
          "Contratos, proteção de dados e questões legais para startups.",
      },
    ],
    isVerified: true,
    avgRating: 4.9,
    ...
    offerings: [
      {
        ...
        sessionPrice: 55,
        description:
          "Validação de ideias, captação de investimento e crescimento inicial.",
      },
      {
        id: "o11",
        ...
        sessionPrice: 40,
        description:
          "Planeamento de carreira, transições profissionais e networking.",
      },
    ],
    isVerified: true,
    avgRating: 4.5,
    ...
    offerings: [
      {
        ...
        sessionPrice: 55,
        description:
          "Roadmap, priorização e discovery de produto para PMs em início de carreira.",
      },
    ],
    isVerified: true,
    avgRating: 4.7,
    ...
    offerings: [
      {
        ...
        sessionPrice: 35,
        description:
          "Prospecção, negociação e fecho de vendas para quem está a começar.",
      },
    ],
    isVerified: true,
    avgRating: 4.4,
    ...
    offerings: [
      {
        ...
        sessionPrice: 30,
        description:
          "Como escrever textos que convertem, para redes sociais e portfólio.",
      },
      {
        id: "o15",
        ...
        sessionPrice: 45,
        description:
          "Posicionamento e narrativa profissional para LinkedIn e portfólio.",
      },
    ],
    isVerified: true,
    avgRating: 4.8,
    ...
    offerings: [
      {
        ...
        sessionPrice: 80,
        description:
          "Sessões avançadas sobre design de sistemas, escalabilidade e boas práticas.",
      },
      {
        id: "o17",
        ...
        sessionPrice: 60,
        description:
          "Para devs que querem migrar de carreira técnica para produto.",
      },
    ],
    isVerified: true,
    avgRating: 4.3,
...
export const MOCK_POSTS = [
  {
    ...
    type: "text",
    content:
      "Acabei de terminar mais uma sessão de mentoria sobre React Hooks — adoro ver a cara de quem finalmente percebe o useEffect!",
    imageUrl: "",
  ...
  },
  {
    ...
    type: "text",
    content:
      "Dica rápida de marketing digital: antes de investir em anúncios pagos, garante que o teu funil orgânico já está a converter. Poupa-te dinheiro e frustração.",
    imageUrl: "",
  ...
  },
  {
    ...
    type: "text",
    content:
      "O meu primeiro post na Mentora! Ansiosa para conhecer os mentorados por aqui.",
    imageUrl: "",
    likedBy: ["m1"],
  ...
  },
  {
    ...
    type: "text",
    content:
      "Empreender não é sobre ter a ideia perfeita, é sobre validar rápido e errar barato. Falamos mais sobre isto na próxima sessão.",
    imageUrl: "",
    likedBy: ["m2", "m3"],
  ...
  },
  {
    ...
    type: "text",
    content:
      "Portfólio bom não é o que tem mais projetos, é o que conta a melhor história sobre como pensas. Qualidade > quantidade.",
    imageUrl: "",

const { createOffering, updateOffering, deleteOffering } = require("./offering.service");
...
module.exports = { createOfferingController, updateOfferingController, deleteOfferingController };